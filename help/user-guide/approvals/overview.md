---
title: GenStudio审阅和批准
description: 了解GenStudio审核和批准流程。
feature: Approval
...
GenStudio的审查和批准工作流程确保所有利益相关者（从创意团队到法律专家）能够有效地审查和批准活动组件，包括创意人工智能生成的品牌资产。

## [!DNL Review and Approval]工作流优势

* **支持稳健的迭代生成AI内容创建**。 在组织中创建和部署品牌一致的内容是一个非常反复的过程。 GenStudio的创作AI功能支持快速创建数百种资源变体。 每个审核者在批准资产草稿之前，可能会请求对资产草稿进行多项更改。 审核者越多，在所有利益相关者就最终变体达成一致之前，潜在的迭代次数越多。
...
当草稿完成审阅和批准流程并发布到[!DNL Content]时，草稿ID过期，并且GenStudio未保存关联的评论和批准状态。 草稿URL不再有效。
...
GenStudio的产品内通知会实时更新批准者和内容创建者，以便了解资源状态更改和查看注释。 通知支持在多个审阅、编辑和批准周期中快速迭代。
