...
description: 了解如何按照GenStudio for Performance Marketing教程完成端到端流程，例如创建电子邮件体验。
...
# Adobe GenStudio for Performance Marketing 教程

Adobe GenStudio for Performance Marketing教程遵循基本的分步工作流程，这些工作流程包含指向用户指南中更深入概念的链接。

本指南中的教程详细介绍了在GenStudio for Performance Marketing中成功生成高质量营销内容所需的概念、先决条件、最佳实践以及各个步骤。
