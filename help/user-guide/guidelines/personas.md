...
GenStudio for Performance Marketing利用准则（[[!DNL Brands]、 [!DNL Products]和 [!DNL Personas]](overview.md)）和Adobe的创作AI技术的强大功能来为您的目标客户策划个性化的营销内容。&#x200B;

GenStudio for Performance Marketing中的![[!DNL Personas]准则](/help/assets/personas-guidelines.png){width="650" zoomable="yes"}

**要查看或修改角色**：

1. 在左侧导航区域中，单击&#x200B;**[!UICONTROL 角色]**。
1. 要[查看个人详细信息或修改角色](add-guidelines.md#manage-personas)，请单击&#x200B;_[!DNL Personas]_&#x200B;操作菜单，然后选择&#x200B;**打开**。
