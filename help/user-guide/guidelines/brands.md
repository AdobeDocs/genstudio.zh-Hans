...
您可以将品牌准则文档(最多三个PDF或DOC文件)上传到GenStudio for Performance Marketing以自动创建品牌。 请参阅[添加准则](add-guidelines.md)，了解如何向GenStudio for Performance Marketing添加品牌、修改品牌和发布品牌等。
