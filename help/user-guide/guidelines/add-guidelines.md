---
title: 向GenStudio添加准则
description: 了解如何在Adobe [!DNL GenStudio]中添加准则 — [!DNL Brands]、 [!DNL Products]和 [!DNL Personas]。
...
[[!DNL Brands]](/help/user-guide/guidelines/brands.md)、[[!DNL Products]](/help/user-guide/guidelines/products.md)和[[!DNL Personas]](/help/user-guide/guidelines/personas.md)是GenStudio中的用户定义的准则，可确保自定义任何AI生成的内容以符合品牌标识，从而实现内容的有效个性化。

请参阅[GenStudio指南概述](/help/user-guide/guidelines/overview.md)。

将准则添加到GenStudio是创建过程中的重要步骤。 准则告知内容创建过程，以及用户定义的提示和Adobe创作AI技术，以制作有影响力的资源。

## 添加[!DNL Brands]

要将品牌添加到GenStudio，您可以[上传品牌指南](#upload-brand-guidelines)或[通过选择指南并输入品牌详细信息来手动创建品牌](#manually-add-brand)。 [将品牌](#publish-brand)Publish到[!DNL Content]以使其可用于生成变体。
...
GenStudio使用Adobe的创作AI技术，从您上传的文档中提取信息并开始构建您的品牌。 当GenStudio从品牌文档中汇编每个准则时，您会看到填充的品牌信息，例如品牌声音、渠道和图像准则。

弹出窗口提醒您在[发布品牌](#publish-brand)之前查看提取的内容。

### 手动添加品牌

您可以在GenStudio中手动添加品牌详细信息，而不是上传现有品牌文档，以填充新的[品牌](brands.md)。
...
您无需[发布](#publish-brand)您的品牌即可访问信息。 任何手动添加的信息在添加后立即可用。 对于组织中的其他人要在GenStudio中使用品牌信息，您必须发布该品牌信息。
...
发布的品牌现在可用于在&#x200B;_[!DNL Create]_或_[!DNL Content]_&#x200B;中生成变体。
...
您可以在GenStudio中添加[!DNL Products]，以在创建内容时指定各个产品焦点区域。<!-- Add Rename, display, reposition functionality -->
...
您可以在GenStudio中添加[!DNL Persona]，以帮助将您创建的内容定位到您的理想受众。
