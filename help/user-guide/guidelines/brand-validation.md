...
1. 若要获取需要改进的资产部分和准则的详细信息，请单击&#x200B;**[!UICONTROL 审核]** _或_，单击顶部菜单栏中的“品牌验证”图标以打开&#x200B;_品牌验证面板_。
...
1. 在&#x200B;_品牌验证面板_&#x200B;的顶部，使用箭头浏览每个变体（例如，使用箭头从`Email 1`移动到`Email 2`），并继续修订变体部分，以更好地遵循您的品牌。
